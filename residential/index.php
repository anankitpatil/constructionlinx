...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3"> <a class="mbutton active" href="<?php echo $PATH; ?>residential/" class="smooth" title="Construction Linx Property Maintenance & Home Improvements Company, Crewe, Cheshire & North West | Residential">Residential</a> </div>
  </div>
</div>
  ...
  <div class="col-lg-12">
    <div>
	  ...
	  while($sections = mysql_fetch_array($data)) { ?>
      	<p><?php if($sections['title'] == 'RESIDENTIAL') {
