...
<div class="container different">
  ...
  <div class="row">
    ...
    <div class="col-lg-10 col-md-10">
      <p>We pride ourselves on our effective project management so you have complete peace of mind that trades are optimally co-ordinated. We ensure the work is carried out to a high standard, on time and on budget.</p>
      <p>Since 2005, we have acquired a loyal customer base due to our responsiveness, attention to detail and high levels of customer care. Construction Linx is committed to making property maintenance easy. You simply make one call and we do the rest.</p>
    </div>
    <div class="col-lg-1 col-md-1"></div>
  </div>
</div>
<div class="container-fluid different-green">
  <div class="container">
    <div class="row">
      ...
      <div class="carousel slide" data-ride="carousel">
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <div class="col-lg-12"><i class="fa fa-quote-left"></i></div>
            <div class="col-lg-12 text-center">
              <h1>They helped us through the entire project, from initial designing all the way to industrial cleaning of the carpets prior to our moving in.</h1>
            </div>
            <div class="col-lg-12"><i class="fa fa-quote-right"></i></div>
            <div class="col-lg-12 text-center">
              <p>Chris Sumner / Industrious</p>
            </div>
          </div>
          <div class="item">
            <div class="col-lg-12"><i class="fa fa-quote-left"></i></div>
            <div class="col-lg-12 text-center">
              <h1>I would recommend them to any school who are considering building development projects.</h1>
            </div>
            <div class="col-lg-12"><i class="fa fa-quote-right"></i></div>
            <div class="col-lg-12 text-center">
              <p>Simon Dyson BA (Hons) NPQH / Head Teacher</p>
            </div>
          </div>
          <div class="item">
            <div class="col-lg-12"><i class="fa fa-quote-left"></i></div>
            <div class="col-lg-12 text-center">
              <h1>Construction Linx gives me an excellent management team to complete multiple projects.</h1>
            </div>
            <div class="col-lg-12"><i class="fa fa-quote-right"></i></div>
            <div class="col-lg-12 text-center">
              <p>Chris Sumner / Industrious</p>
