...
<div class="container-fluid different-green" id="benefits">
  <div class="container">
    <div class="row">
    ...
    <div class="col-lg-10 col-md-10 col-sm-10">
      ...
      <div class="carousel slide" data-ride="carousel">
        <div class="carousel-inner" role="listbox">
          <?php include("../admin/alltest.php");
		  $i = 0;
		  while($tests = mysql_fetch_array($data)) { ?>
          <div class="item <?php if($i == 0) echo 'active'; ?>">
            <div class="col-lg-12"><i class="fa fa-quote-left"></i></div>
            <div class="col-lg-12 text-center">
              <h3><?php echo nl2br($tests['content']); ?></h3>
            </div>
            <div class="col-lg-12"><i class="fa fa-quote-right"></i></div>
            <div class="col-lg-12 text-center">
              <p><?php echo $tests['ref']; ?></p>
            </div>
          </div>
          <?php $i++; } ?>
        </div>
